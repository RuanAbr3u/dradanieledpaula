...
const badges = ['Atendimento Humanizado', 'RPG', 'Fisioterapia', 'Avaliação Individual']

export default function Hero() {
  return (
    <section id="inicio" className="relative isolate overflow-hidden pb-20 pt-28 sm:pt-36 lg:pb-28 lg:pt-40">
      ...
      <div className="section-shell grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
        <Reveal className="order-2 max-w-3xl lg:order-1">
          <p className="eyebrow mb-6 sm:mb-7">Recupere seus movimentos sem dor.</p>
          <h1 className="font-display text-[clamp(3.35rem,12vw,7.8rem)] font-semibold leading-[0.88] tracking-[0] text-[var(--color-ink)] sm:leading-[0.86]">
            Movimento com técnica, cuidado e acolhimento.
          </h1>
          <p className="section-copy mt-6 max-w-xl sm:mt-7">
        ...
        <Reveal delay={100} className="order-1 relative min-h-[390px] sm:min-h-[620px] lg:order-2 lg:min-h-[720px]">
          ...
          <div className="absolute right-0 top-8 h-[80%] w-[86%] overflow-hidden rounded-[44%_56%_42%_58%/50%_36%_64%_50%] border-[8px] border-white/75 bg-white shadow-[0_28px_80px_rgba(52,43,34,0.14)] sm:top-10 sm:h-[82%] sm:w-[78%] sm:border-[12px] lg:shadow-[0_40px_100px_rgba(52,43,34,0.16)]">
            <img
              src="/foto.jpeg"
